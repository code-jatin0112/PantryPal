        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate>
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between pt-1">
              ...
              <button
                type="button"
                onClick={() => toast("Password reset instructions will be sent to your email.", { icon: "ℹ️" })}
                className="text-sm font-medium text-[#8A9070] hover:text-[#757C5F] hover:underline focus:outline-none transition-colors"
              >
                Forgot password?
              </button>
            </div>
